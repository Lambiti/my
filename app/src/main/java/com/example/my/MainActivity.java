...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    private Button
            ...
            mc, c, help, percent;                  // mem清屏键    input清屏键 帮助 百分号
    ...
    public boolean equals_flag = true;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            div = (Button) findViewById(R.id.bt_除);
            mul = (Button) findViewById(R.id.bt_乘);
            sub = (Button) findViewById(R.id.bt_减);
            add = (Button) findViewById(R.id.bt_加);
            equal = (Button) findViewById(R.id.bt_等号);
            sin = (Button) findViewById(R.id.bt_sin);
            cos = (Button) findViewById(R.id.bt_cos);
            tan = (Button) findViewById(R.id.bt_tan);
            log = (Button) findViewById(R.id.bt_log);
            ln = (Button) findViewById(R.id.bt_ln);
            square = (Button) findViewById(R.id.bt_平方);
            factorial = (Button) findViewById(R.id.bt_阶乘);
            bksp = (Button) findViewById(R.id.bt_退格);
            left = (Button) findViewById(R.id.bt_左括号);
            right = (Button) findViewById(R.id.bt_右括号);
            dot = (Button) findViewById(R.id.bt_小数点);
            c = (Button) findViewById(R.id.bt_C);
            drg = (Button) findViewById(R.id.bt_drg);
            help = (Button) findViewById(R.id.bt_帮助);
            percent = (Button) findViewById(R.id.bt_百分号);
            for (int i = 0; i < 10; ++i) {
